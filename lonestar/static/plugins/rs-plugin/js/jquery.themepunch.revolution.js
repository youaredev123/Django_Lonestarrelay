	...
	jQuery.fn.extend({
		...
		revolution: function(options) {
				...
				defaults = {
					...
					navigationStyle:"round-old",				// round,square,navbar,round-old,square-old,navbar-old, or any from the list in the docu (choose between 50+ different item),
